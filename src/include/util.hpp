...
#define INIT 1 // 控制本地初始化过程信息(queu data的打开等等)的打印
#define CONNECT 1 // 控制网络连接初始化过程信息(tcp连接、fd的初始化)的打印
#define SYNC_DATA 1 // 控制之前版本在构造函数中sync_data的信息打印
...
#define VPROT 0 // 比较verbose的状态转化信息
